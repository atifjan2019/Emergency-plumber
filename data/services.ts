...
export const services: Service[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { question: 'How do you quote for a boiler repair?', answer: 'The cost depends on the failed part and your boiler model. After diagnosis we explain the fault and confirm a fixed quote before any work begins, so you decide with the full picture.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { question: 'How do you quote for leak detection?', answer: 'After a quick assessment we confirm a fixed quote for the survey before starting. Most domestic surveys are completed within about two hours.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { question: 'How do you quote to unblock a toilet?', answer: 'Most domestic toilet clearances are completed quickly on the same visit. We confirm a clear quote before any work begins - no surprises on the invoice.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { question: 'How do you quote for a powerflush?', answer: 'It depends on the size of your system and how much sludge has built up. We assess the system first and confirm a fixed quote before starting.' },
